...
class DentaBot extends ActivityHandler {
    constructor(configuration, qnaOptions) {
        ...
        this.onMessage(async (context, next) => {
            ...
            // don't forget 'await'
            console.log("Will get your answer");
            ...
            if (luis.luisResult.prediction.topIntent === 'ScheduleAppointment' && luis.intents.ScheduleAppointment.score > 0.5) {
                if (luis.entities.$instance && luis.entities.$instance.time) {
                    ...
                    const setupAppointment = await this.DentistScheduler.scheduleAppointment();
                    await context.sendActivity(setupAppointment);
                    await next();
                    return;
                }
            ...
            // } else {
            //     await context.sendActivity('I\'m sorry, I don\'t understand. Please try again, You can ask me questions about apointment or session availability.');
            // }
            await next();
        });
